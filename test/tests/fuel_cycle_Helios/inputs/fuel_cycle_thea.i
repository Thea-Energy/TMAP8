# Input file is based on the deuterium-tritium fuel cycle model described
# by Abdou et al (2021) but adapted for the Thea Helios machine.
...
# Tritium burn fraction will be best guess based on
# the plasma performance and particle confinement time
...
[ScalarKernels]
  ...
  [I1] # Breeding Zone
    ...
    expression = '-(AF * tritium_burn_rate * TBR + (1 - TES_efficiency)*T_02_TES/residence2 - T_01_BZ/residence1 - T_01_BZ*epsilon1/residence1 - T_01_BZ*tdecay)'
    variable = 'T_01_BZ'
    coupled_variables = 'T_02_TES'
    postprocessors = 'AF TBR tritium_burn_rate TES_efficiency residence1 residence2 tdecay epsilon1'
  []
  ...
  [I3] #First Wall
    type = ParsedODEKernel
    expression = '-(P_FW_leak_fraction * AF * tritium_burn_rate /tritium_burn_fraction / tritium_fueling_efficiency + HX_FW_leak_fraction * (1 - HX_CPS_leak_fraction) * (1 - HX_EXO_leak_fraction)
    ...
    postprocessors = 'P_FW_leak_fraction AF tritium_burn_rate tritium_burn_fraction tritium_fueling_efficiency HX_FW_leak_fraction HX_CPS_leak_fraction HX_EXO_leak_fraction residence5 CPS_FW_leak_fraction CPS_efficiency residence6 residence3 tdecay epsilon3'
  []
  [I4] #Divertor
    type = ParsedODEKernel
    expression = '-(P_DIV_leak_fraction * AF * tritium_burn_rate/tritium_burn_fraction / tritium_fueling_efficiency + (1-HX_FW_leak_fraction)*
    ...
    postprocessors = 'P_DIV_leak_fraction AF tritium_burn_rate tritium_burn_fraction tritium_fueling_efficiency HX_FW_leak_fraction HX_CPS_leak_fraction HX_EXO_leak_fraction residence5 CPS_FW_leak_fraction CPS_efficiency residence6 residence4 tdecay epsilon4'
  []
  [I5] #Heat eXchanger
    type = ParsedODEKernel
  ...
  [I7] #Vacuum Pump
    ...
    expression = '-((1- tritium_burn_fraction*tritium_fueling_efficiency - P_FW_leak_fraction - P_DIV_leak_fraction)*
                  AF*tritium_burn_rate/(tritium_burn_fraction * tritium_fueling_efficiency) - T_07_vacuum/residence7 - T_07_vacuum*epsilon7/residence7 - T_07_vacuum*tdecay)'
    variable = 'T_07_vacuum'
    postprocessors = 'AF tritium_burn_rate tritium_fueling_efficiency P_FW_leak_fraction P_DIV_leak_fraction tritium_burn_fraction residence7 tdecay epsilon7'
  []
  [I8] #Fuel clean-up
    type = ParsedODEKernel
  ...
  [I11] #Storage and Management (STO)
    type = ParsedODEKernel
    expression = '-(FCU_STO_fraction * T_08_FCU/residence8 + (1-ISS_EXO_leak_fraction)*T_09_ISS/residence9 - AF*tritium_burn_rate/tritium_burn_fraction/tritium_fueling_efficiency - T_11_storage*tdecay)'
    variable = 'T_11_storage'
    coupled_variables = 'T_08_FCU T_09_ISS'
    postprocessors = 'FCU_STO_fraction residence8 ISS_EXO_leak_fraction residence9 AF tritium_burn_rate tritium_burn_fraction tritium_fueling_efficiency tdecay'
  []
[]
...
[Postprocessors]
  ...
  [residence7] #Vac
    type = ConstantPostprocessor
    execute_on = 'TIMESTEP_BEGIN INITIAL LINEAR NONLINEAR'
    value = 60 # 30 minutes (20-30 minutes)
  []
  [residence8] #FCU
    type = ConstantPostprocessor
    execute_on = 'TIMESTEP_BEGIN INITIAL LINEAR NONLINEAR'
  ...
  [tritium_burn_rate]
    type = ConstantPostprocessor
    execute_on = 'TIMESTEP_BEGIN INITIAL LINEAR NONLINEAR'
    value = 1.701e-6 # kg / s = 0.195 kg/day
  []
